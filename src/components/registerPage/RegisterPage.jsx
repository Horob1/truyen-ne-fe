      ...
      <div className="flex bg-gradient-to-r from-green-300 via-blue-500 to-purple-600  h-[100vh] bg-[length:300%_300%] animate-color-so-slow w-[100%]">
        <div className="m-auto bg-white rounded-2xl  drop-shadow-sm w-[98%] md:w-[460px] z-10">
          ...
          <form class="w-[80%] mx-auto">
            ...
            <button
              type="submit"
              class="text-white mb-8 w-[100%] rounded-4xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600  hover:opacity-70 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center0"
            >
              Submit
            </button>
            <Link to="/log-in">
        ...
        <div className="absolute h-[100vh] w-[100%] overflow-hidden">
          ...
          <div className="absolute origin-center rotate-45 w-[500px] h-[500px] rounded-full right-[-400px] top-[200px] bg-white opacity-20"></div>
          <div className="absolute origin-center rotate-45 w-[500px] h-[500px] rounded-full bottom-[-350px] left-[500px] bg-white opacity-20"></div>
