    ...
    <div className="flex bg-gradient-to-r from-rose-400 to-orange-300 h-[100vh] bg-[length:300%_300%] animate-color-so-slow w-[100%]">
      <div className="m-auto bg-white rounded-2xl  drop-shadow-sm w-[98%] md:w-[460px] z-10">
        ...
        <form class="w-[80%] mx-auto ">
          ...
          <button
            type="submit"
            class="text-white w-[100%] mb-8 rounded-4xl bg-gradient-to-r  from-rose-400 to-orange-300  hover:opacity-70 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center0"
          >
            Send Code
          </button>
        </form>
